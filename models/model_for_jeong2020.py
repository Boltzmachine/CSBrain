...
# Jeong2020 60-channel scalp EEG montage, in the MOABB acquisition order (== the
# LMDB sample channel order). The 4 EOG + 7 EMG channels MOABB mistypes as EEG
# are dropped upstream, leaving this pure 60-channel scalp set.
SELECTED_CHANNELS = [
    'Fp1', 'AF7', 'AF3', 'AFz', 'F7', 'F5', 'F3', 'F1', 'Fz',
    'FT7', 'FC5', 'FC3', 'FC1', 'T7', 'C5', 'C3', 'C1', 'Cz',
    'TP7', 'CP5', 'CP3', 'CP1', 'CPz', 'P7', 'P5', 'P3', 'P1', 'Pz',
    'PO7', 'PO3', 'POz',
    'Fp2', 'AF4', 'AF8', 'F2', 'F4', 'F6', 'F8',
    'FC2', 'FC4', 'FC6', 'FT8', 'C2', 'C4', 'C6', 'T8',
    'CP2', 'CP4', 'CP6', 'TP8', 'P2', 'P4', 'P6', 'P8',
    'PO4', 'PO8', 'O1', 'Oz', 'O2', 'Iz',
]
...
# Case-insensitive: Jeong channel names are mixed-case (Fp1, AFz, Cz, POz, Iz).
def _region_of(ch):
    ch = ch.upper()
    if ch.startswith('FT'):
        return 2
