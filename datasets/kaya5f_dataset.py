...
class CustomDataset(Dataset):
    """Kaya2018 5F 5-class five-finger motor-imagery dataset.

    Samples are stored as (19, 1, 200) float32 in micro-volts; the model
    consumes ``x/100`` (matching the other downstream datasets). Labels are
    0..4 (thumb, index, middle, ring, little finger MI).
    """
