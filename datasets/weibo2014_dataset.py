...
class CustomDataset(Dataset):
    """Weibo2014 7-class simple+compound limb motor-imagery dataset.

    Samples are stored as (60, n_win, 200) float32 in micro-volts; the model
    consumes ``x/100`` (matching the other downstream datasets). Labels are
    0..6 (left_hand, right_hand, hands, feet, left_hand_right_foot,
    right_hand_left_foot, rest).
    """
