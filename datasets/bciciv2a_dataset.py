...
class LoadDataset(object):
    ...
    def get_data_loader(self):
        train_set = CustomDataset(self.datasets_dir, self.params, mode='train')
        val_set = CustomDataset(self.datasets_dir, self.params, mode='val')
        test_set = CustomDataset(self.datasets_dir, self.params, mode='test')
